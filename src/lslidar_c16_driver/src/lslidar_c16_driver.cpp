...
namespace lslidar_c16_driver {
            ...
            Node("lslidar_node", options)//,  diagnostics_(this)
    {
        ...
        this->declare_parameter("model", config_.model);
        this->declare_parameter("degree_mode", config_.degree_mode);
        this->declare_parameter("return_mode", config_.return_mode);
        this->declare_parameter("rpm", config_.rpm);
...
/*	this->declare_parameter("npackets");
	this->get_parameter("npackets", config_.npackets);*/
        ...
        this->declare_parameter("msop_port", 3368);
        this->declare_parameter("difop_port", 3369  );
        ...
        this->declare_parameter("output_packets_topic", output_packets_topic);
        this->declare_parameter("output_difop_topic", output_difop_topic);
        this->declare_parameter("time_synchronization", time_synchronization_);
