...
namespace lslidar_rawdata {
    ...
    void RawData::loadConfigFile() {
        ...
        return_mode_ = 1;
        private_nh_->declare_parameter("start_angle", 0.0);
        private_nh_->declare_parameter("end_angle", 360.0);
        private_nh_->declare_parameter("max_distance", 200.0);
        private_nh_->declare_parameter("min_distance", 0.2);
        private_nh_->declare_parameter("degree_mode", 0);
        private_nh_->declare_parameter("distance_unit", 0.25);
        private_nh_->declare_parameter("config_vert", true);
        private_nh_->declare_parameter("print_vert", true);
        private_nh_->declare_parameter("model", model);
