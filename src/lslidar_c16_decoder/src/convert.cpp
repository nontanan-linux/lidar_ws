...
/** @brief Constructor. */
    Convert::Convert(const rclcpp::NodeOptions &options) : Node("cloud_node", options),
        ...
        this->declare_parameter("output_points_topic", output_points_topic);
        this->declare_parameter("input_packets_topic", input_packets_topic);
        this->declare_parameter("time_synchronization", time_synchronization_);
        this->declare_parameter("scan_num", scan_num);
        this->declare_parameter("publish_scan", publish_scan);
        this->declare_parameter("scan_frame_id", scan_frame_id);
